...
$(document).ready(function () {
    ...
    */
    ...
    $("#ReturnBtn").click(function () {
        $("#content").load("http://" + window.location.host + "/PXFRONT/PXAS/PXAS0020/PXAS0021VW");
    });
...
function LoadDialogHtml(id, callback) {
    LoaderControl("open");
    $("#dialog").load("http://" + window.location.host + "/PXFRONT/PXAS/PXAS0020/_PXAS0022VW", function () {
        LoaderControl("close");
